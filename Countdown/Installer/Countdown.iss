...
[Files]
Source: "..\bin\Release\win-arm64\publish\*"; Excludes: "*.pdb, *WebView2*"; DestDir: "{app}"; Check: PreferArm64Files; Flags: ignoreversion recursesubdirs;
Source: "..\bin\Release\win-x64\publish\*";   Excludes: "*.pdb, *WebView2*"; DestDir: "{app}"; Check: PreferX64Files;   Flags: ignoreversion recursesubdirs solidbreak;

...
internal sealed class PostfixMap
{
    ...
    private PostfixMap()
    {
        ...
        map[2].Add([3, 0, 0, 1, 0]);
        map[2].Add([2, 0, 2, 0, 0]);
        map[2].Add([2, 0, 1, 0, 1, 0]);

        // map entries for 5 tiles
        map[3].Add([5, 0, 0, 0, 0]);
        map[3].Add([4, 0, 1, 0, 0, 0]);
        map[3].Add([4, 0, 0, 1, 0, 0]);
        map[3].Add([4, 0, 0, 0, 1, 0]);
        map[3].Add([3, 0, 2, 0, 0, 0]);
        map[3].Add([3, 0, 1, 0, 1, 0, 0]);
        map[3].Add([3, 0, 1, 0, 0, 1, 0]);
        map[3].Add([3, 0, 0, 2, 0, 0]);
        map[3].Add([3, 0, 0, 1, 0, 1, 0]);
        map[3].Add([2, 0, 3, 0, 0, 0]);
        map[3].Add([2, 0, 2, 0, 1, 0, 0]);
        map[3].Add([2, 0, 2, 0, 0, 1, 0]);
        map[3].Add([2, 0, 1, 0, 2, 0, 0]);
        map[3].Add([2, 0, 1, 0, 1, 0, 1, 0]);

        // map entries for 6 tiles
        map[4].Add([6, 0, 0, 0, 0, 0]);
        map[4].Add([5, 0, 1, 0, 0, 0, 0]);
        map[4].Add([5, 0, 0, 1, 0, 0, 0]);
        map[4].Add([5, 0, 0, 0, 1, 0, 0]);
        map[4].Add([5, 0, 0, 0, 0, 1, 0]);
        map[4].Add([4, 0, 2, 0, 0, 0, 0]);
        map[4].Add([4, 0, 1, 0, 1, 0, 0, 0]);
        map[4].Add([4, 0, 1, 0, 0, 1, 0, 0]);
        map[4].Add([4, 0, 1, 0, 0, 0, 1, 0]);
        map[4].Add([4, 0, 0, 2, 0, 0, 0]);
        map[4].Add([4, 0, 0, 1, 0, 1, 0, 0]);
        map[4].Add([4, 0, 0, 1, 0, 0, 1, 0]);
        map[4].Add([4, 0, 0, 0, 2, 0, 0]);
        map[4].Add([4, 0, 0, 0, 1, 0, 1, 0]);
        map[4].Add([3, 0, 3, 0, 0, 0, 0]);
        map[4].Add([3, 0, 2, 0, 1, 0, 0, 0]);
        map[4].Add([3, 0, 2, 0, 0, 1, 0, 0]);
        map[4].Add([3, 0, 2, 0, 0, 0, 1, 0]);
        map[4].Add([3, 0, 1, 0, 2, 0, 0, 0]);
        map[4].Add([3, 0, 1, 0, 1, 0, 1, 0, 0]);
        map[4].Add([3, 0, 1, 0, 1, 0, 0, 1, 0]);
        map[4].Add([3, 0, 1, 0, 0, 2, 0, 0]);
        map[4].Add([3, 0, 1, 0, 0, 1, 0, 1, 0]);
        map[4].Add([3, 0, 0, 3, 0, 0, 0]);
        map[4].Add([3, 0, 0, 2, 0, 1, 0, 0]);
        map[4].Add([3, 0, 0, 2, 0, 0, 1, 0]);
        map[4].Add([3, 0, 0, 1, 0, 2, 0, 0]);
        map[4].Add([3, 0, 0, 1, 0, 1, 0, 1, 0]);
        map[4].Add([2, 0, 4, 0, 0, 0, 0]);
        map[4].Add([2, 0, 3, 0, 1, 0, 0, 0]);
        map[4].Add([2, 0, 3, 0, 0, 1, 0, 0]);
        map[4].Add([2, 0, 3, 0, 0, 0, 1, 0]);
        map[4].Add([2, 0, 2, 0, 2, 0, 0, 0]);
        map[4].Add([2, 0, 2, 0, 1, 0, 1, 0, 0]);
        map[4].Add([2, 0, 2, 0, 1, 0, 0, 1, 0]);
        map[4].Add([2, 0, 2, 0, 0, 2, 0, 0]);
        map[4].Add([2, 0, 2, 0, 0, 1, 0, 1, 0]);
        map[4].Add([2, 0, 1, 0, 3, 0, 0, 0]);
        map[4].Add([2, 0, 1, 0, 2, 0, 1, 0, 0]);
        map[4].Add([2, 0, 1, 0, 2, 0, 0, 1, 0]);
        map[4].Add([2, 0, 1, 0, 1, 0, 2, 0, 0]);
        map[4].Add([2, 0, 1, 0, 1, 0, 1, 0, 1, 0]);
